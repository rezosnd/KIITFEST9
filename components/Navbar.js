...
export default function Navbar({ variant = 'dark' }) {
  ...
  return (
    <header className="w-full ">
      {/* <nav
        className={`navbar ${variant === 'light' ? 'navbar-light' : 'navbar-dark'} py-8`}
        style={{ paddingTop: '2rem', paddingBottom: '3rem' }}
      >
        <div className="flex items-center justify-between w-full">
          <Link href="/" className="flex items-center justify-start">
            <Image
              src="/indexbg/KIIT_pixel.png"
              alt="logo"
              width={50}
              height={50}
              className="img h-30 w-auto"
            />
          </Link>
          ...
          <Link href="/" className="flex items-center justify-start group">
            ...
            >
              <Image
                ...
                width={50}
                height={60}
                className="img h-35 w-auto"
                style={{ imageRendering: 'pixelated' }}
              />
              {/* Pixel corner accents */}
              <span
                className="absolute -top-1 -left-1 w-2 h-2"
                style={{ backgroundColor: '#7A3BFF' }}
              />
              <span
            ...
            {/* Pixel-style title text next to logo */}
            <div className="ml-3 hidden sm:flex flex-col leading-none">
              <span
                className="text-s font-bold tracking-widest uppercase"
                style={{
                  color: '#3CFFF3',
                  fontFamily: 'monospace',
                  textShadow: '1px 1px 0 #7A3BFF, -1px -1px 0 #7A3BFF',
                  letterSpacing: '0.2em',
                }}
              >
                ▶ KIIT FEST
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              ...
              style={{
                ...
                fontFamily: 'monospace',
                boxShadow: '3px 3px 0 #7A3BFF',
                imageRendering: 'pixelated',
              }}
              onMouseEnter={(e) => {
                e.currentTarget.style.boxShadow = '1px 1px 0 #7A3BFF'
                e.currentTarget.style.transform = 'translate(2px, 2px)'
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.boxShadow = '3px 3px 0 #7A3BFF'
            ...
            <button
              ...
              style={{
                ...
                boxShadow: '3px 3px 0 #FF3300',
                minWidth: '44px',
                minHeight: '44px',
              }}
              onMouseEnter={(e) => {
                e.currentTarget.style.boxShadow = '1px 1px 0 #FF3300'
                e.currentTarget.style.transform = 'translate(2px, 2px)'
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.boxShadow = '3px 3px 0 #FF3300'
                e.currentTarget.style.transform = 'translate(0, 0)'
              }}
            >
              {/* Pixel bars instead of generic svg */}
              <span
                className="block w-6 h-1"
                style={{ backgroundColor: '#FFEF12' }}
              />
              <span
                className="block w-4 h-1 self-end"
                style={{ backgroundColor: '#3CFFF3' }}
              />
              <span
                className="block w-5 h-1 self-end"
        ...
        {open && (
          <div className="fixed inset-0 z-[1200] flex items-start justify-center pt-16 px-2 bg-[#171717]/85 backdrop-blur-sm">
            <div
              ...
              style={{
                backgroundImage:
                  'linear-gradient(180deg, #FFEF12 0%, #FF3300 100%)',
                borderColor: '#7A3BFF',
              }}
            >
              <div
                ...
                style={{
                  backgroundImage:
                    'linear-gradient(180deg, #FF3300 0%, #171717 100%)',
                }}
              >
                <div
                  className="rounded-lg p-4 h-80 relative overflow-hidden"
                  ...
                  <div className="absolute top-2 left-2 right-2">
                    <div className="flex items-center gap-2 mb-4">
                      ...
                      <div
                        ...
                        style={{ backgroundColor: '#FFEF12', opacity: 0.3 }}
                      />
                    </div>
                    <div
                      ref={listRef}
                        ...
                        >
                          ...
                          {idx === 0 && (
                            <svg
                              ...
                              strokeLinecap="round"
                              strokeLinejoin="round"
                              className="lucide lucide-chevron-right ml-auto"
                            >
              ...
              <div
                className="h-2 rounded-full mb-3 shadow-inner"
                style={{ backgroundColor: '#7A3BFF' }}
              />
              ...
              <div
                ...
                style={{
                  backgroundImage:
                    'linear-gradient(180deg, #FF2E88 0%, #7A3BFF 100%)',
                }}
              >
                ...
                <div className="flex justify-between items-center">
                  ...
                  <button
                    ...
                    style={{
                      ...
                      border: '2px solid rgb(122, 59, 255)',
                    }}
                    title="Close menu"
                  >
                    {Array.from({ length: 12 }).map((_, i) => (
                      <div
                        ...
                        style={{ backgroundColor: 'rgb(255, 239, 18)' }}
                      />
                    ))}
                  </button>
                    ...
                    <div className="relative w-20 h-20">
                      ...
                      >
                        <svg
                          ...
                          strokeLinecap="round"
                          strokeLinejoin="round"
                          className="lucide lucide-chevron-up mx-auto text-gray-400"
                          aria-hidden="true"
                        >
                      ...
                      >
                        <svg
                          ...
                          strokeLinecap="round"
                          strokeLinejoin="round"
                          className="lucide lucide-chevron-down mx-auto text-gray-400"
                          aria-hidden="true"
                        >
                          <path d="m6 9 6 6 6-6" />
                        </svg>
                      ...
                      >
                        <svg
                          ...
                          strokeLinecap="round"
                          strokeLinejoin="round"
                          className="lucide lucide-chevron-left mx-auto text-gray-400"
                          aria-hidden="true"
                        >
                      ...
                      >
                        <svg
                          ...
                          strokeLinecap="round"
                          strokeLinejoin="round"
                          className="lucide lucide-chevron-right mx-auto text-gray-400"
                          aria-hidden="true"
                        >
                          <path d="m9 18 6-6-6-6" />
                        </svg>
