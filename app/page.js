...
// Color theme inspired by the pixel slot machine: purple dome, red band,
...
function CountdownTimer() {
  ...
  return (
    ...
    >
      {/* "INSERT COIN" header strip — mimics the red band on the slot machine */}
      <div
        style={{
      ...
      {/* Digit boxes — styled like the blue face panel with gold dot buttons */}
      <div
        style={{
          display: 'flex',
          gap: '8px',
          background: 'linear-gradient(180deg, #5B8FCC 0%, #3A66A0 100%)',
          border: '4px solid #C8860A',
          padding: '10px 16px',
          boxShadow: '0 0 0 3px #7A3BFF, 0 4px 20px rgba(0,0,0,0.6)',
          imageRendering: 'pixelated',
        }}
      >
        {units.map((u, i) => (
            ...
            >
              ...
              <div
                style={{
                  ...
                  fontWeight: 'bold',
                  color: '#FFEF12',
                  textShadow: '0 0 8px #FFEF12, 0 0 2px #fff',
                  letterSpacing: '2px',
              ...
              {/* Label — small red button row style */}
              <div
                style={{
                  backgroundColor: '#CC2200',
      ...
      {/* Coin slot strip at the bottom — mimics the gold coin at the base */}
      <div
        style={{
          background: 'linear-gradient(90deg, #7A3BFF, #CC2200, #7A3BFF)',
          height: '4px',
          width: '80%',
          borderRadius: '2px',
          boxShadow: '0 0 8px #7A3BFF',
        }}
      />
    </div>
  )
...
export default function Page() {
  ...
  useEffect(() => {
    const onScroll = () => {
      ...
      if (astronautRef.current)
        astronautRef.current.style.transform = `translateY(${scrollY * 0.6}px)`
      if (leftImageRef.current)
        leftImageRef.current.style.transform = `translateY(${scrollY * 0.3}px)`
      if (rightImageRef.current)
        rightImageRef.current.style.transform = `translateY(${scrollY * 0.4}px)`
      if (leftCenterRef.current)
        leftCenterRef.current.style.transform = `translateY(${scrollY * 0.3}px)`
      if (bottomRightRef.current)
        bottomRightRef.current.style.transform = `translateY(${scrollY * 0.3}px)`
    }
    window.addEventListener('scroll', onScroll)
    return () => window.removeEventListener('scroll', onScroll)
  }, [])
  ...
  return (
    <div className="home-shell">
      <div className="section text-white min-h-screen flex flex-col items-center justify-between z-20 home-section py-16 pt-24 pb-12">
        {/* Top: logo + ticker */}
        <div className="flex flex-col items-center gap-3">
          <div
            ref={imageRef}
            className="img hero-image h-4/12 w-10/12 md:w-8/12 lg:w-5/12 z-10 img-tilt"
            id="image"
          />
          <img
            ref={festRef}
            ...
            className="img fest-hero-img w-11/12 min-[430px]:w-4/5 sm:w-7/12 md:w-6/12 xl:w-5/12 z-40"
          />
          <div className="text-xs md:text-sm text-yellow-300 headingfont">
            {rotatingTexts[tickerIndex]}
          </div>
        </div>
      ...
      <div className="section text-white z-10 home-section">
        ...
        <div className="flex flex-col items-center justify-center min-h-screen w-full md:w-3/4 lg:h-full mt-14 lg:mt-5 z-30">
          <div className="bg-gray-900 bg-opacity-50 py-3 w-full flex flex-col">
            <div className="message flex items-center justify-start">
              <img
                src="/indexbg/pixelboyhead.png"
                className="h-14 w-14 md:h-16 md:w-16 lg:h-20 lg:w-20 ml-3 mt-2"
                alt="left avatar"
              />
              <div className="bubble w-fit left shadow px-3 py-2 text-[10px] md:text-[14px] lg:text-[20px]">
                Welcome to KIIT Fest
              </div>
            </div>
            <div className="message flex items-center justify-end">
              <div className="bubble w-fit right shadow px-3 py-2 text-[10px] md:text-[14px] lg:text-[20px]">
                Ready to join the quest?
              </div>
              <img
                src="/indexbg/boyheadright.png"
                className="h-14 w-14 md:h-16 md:w-16 lg:h-20 lg:w-20 mr-3 mt-2"
                alt="right avatar"
              />
            </div>
            <div className="message flex items-center justify-start">
            ...
            <div className="message flex items-center justify-start">
              ...
              <a
                href="#contact"
                className="bubble w-fit left shadow px-3 py-2 text-[10px] md:text-[14px] lg:text-[20px]"
              >
                Press start to craft something unique
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row min-h-screen">
          <div className="flex-1 flex items-center justify-center md:min-h-screen">
            <div className="w-11/12 m-5 md:my-10 p-4 md:p-6 border-4 border-[#3CFFF3] bg-[#171717] text-white shadow-[0_0_24px_rgba(60,255,243,0.35)]">
              ...
              <p className="text-[11px] md:text-[14px] lg:text-[18px] text-start p-1 md:p-2 my-5 headingfont leading-relaxed text-[#FFEF12]">
                Hello! Welcome to KIIT Fest 9.0 — an 8-Bit Retro Arcade Universe
                where campus life turns into a game. Inspired by classics like
                Pac-Man, Tetris, Contra and the movie PIXELS, KIIT Fest blends
                technology, culture, competition and creativity into one digital
                playground. Here you don't attend events. You unlock levels.
                Hackathons become Boss Battles. Dance becomes Rhythm Mode. Music
                becomes Soundtrack Mode. Fun becomes Multiplayer. Whether
                you&apos;re a coder, gamer, dancer, singer, designer or explorer
                — this fest has a quest waiting for you. Insert Coin. Start
                Game.
              </p>
            </div>
          </div>
          ...
          <div className="flex-1 flex flex-col items-center justify-center z-30">
            <div className="border-r-4 border-l-4 border-t-4 border-white w-11/12 h-2/12 bg-black">
              <div className="flex">
                ...
                <div className="flex items-center justify-center w-full">
                  <div className="mt-[6px] text-center text-[14px] text-white">
                    /home/arcade
                  </div>
                </div>
              </div>
      ...
      <div className="section text-white home-section" id="events">
        <div className="flex flex-col items-center justify-center min-h-screen w-full">
          <div className="grid grid-cols-1 md:grid-cols-4 mt-4 w-full">
            <div className="col-span-1 order-2 md:order-1 mx-2 my-2 md:my-0">
              <div className="flex flex-col w-full h-full border-4 border-white bg-gray-950 bg-opacity-50">
                <div className="text-center headingfont text-[12px] md:text-[16px] mb-2 py-1 border-b-4 border-white w-full text-white bg-black">
                  Events
                </div>
                <div className="word-box flex flex-row md:flex-col flex-wrap gap-4 justify-start md:justify-center md:items-center text-[9px] md:text-[14px] mt-2 ml-4" />
              </div>
            ...
            <div className="col-span-1 md:col-span-2 order-1 md:order-2">
              <div className="border-t-4 border-l-4 border-r-4 border-white w-full max-w-screen-lg mx-auto">
                <div className="flex items-center justify-center w-full h-full bg-black">
                  <div className="text-center headingfont text-xl text-white">
                    EVENTS.NES
                  </div>
                </div>
              </div>
              <div className="w-full max-w-screen-lg mx-auto relative border-4 border-white flex flex-col md:flex-row">
                <div
                  ...
                  style={{ backgroundColor: '#63adff' }}
                >
                  <div className="duck-hud">
                    <div className="hud-box headingfont">
                      SCORE <span id="score-value">0</span> | HITS{' '}
                      <span id="hits-value">0</span> | MISSES{' '}
                      <span id="misses-value">0</span> | SHOTS{' '}
                      <span id="shots-value">0</span>
                    </div>
                  </div>
                  <img
                    src="/skills.nes/duckhuntbg.png"
                    className="duckhunt-bg h-full w-full object-cover"
                    alt="Duck Hunt"
                  />
                  <img
                    src="/skills.nes/centerimage.gif"
                    className="gameend-bg hidden h-full w-full object-cover"
                    alt="Game End"
                  />
                  <img
                    src="/skills.nes/flyduck.gif"
                    className="bird hidden absolute w-12 h-12 md:w-20 md:h-20 nes-pointer"
                    alt="Bird"
                  />
                  <button
                    id="start-button"
                    className="bulbula medium buton headingfont nes-pointer"
                  >
                    Start Game
                  </button>
                </div>
            ...
            <div
              className="col-span-1 order-3 md:order-3 mx-2 my-2 md:my-0"
              id="arenas"
            >
              <div className="flex flex-col w-full h-full border-4 border-white bg-gray-950 bg-opacity-50">
                <div className="text-center headingfont text-[12px] md:text-[16px] mb-2 border-b-4 border-white w-full bg-black text-white py-1">
                  ARENAS
                </div>
                <div className="word-box-2 flex flex-row md:flex-col flex-wrap gap-4 justify-start md:justify-center md:items-center text-[9px] md:text-[14px] mt-2 ml-4" />
              </div>
